...
# requires R napistu-r for adding additional identifiers
...
python -m napistu load proteinatlas-subcell $CACHE_DIR_PATH/hpa_subcell.tsv
...
python -m napistu consensus create --nondogmatic $reactome_input $string_input $trrust_input $dogma_input $output_uri $bigg_input
```
...
if [[ -f $input_uri ]] ; then
    ...
    python -m napistu exporter export_precomputed_distances -s 3 -q 0.1 -w "['weights', 'upstream_weights']" $input_uri $output_uri
else
    echo "Missing $input_uri"
fi
```
